...
(function(init) {
    ...
    return skate('aui-inline-dialog2', {
        ...
        prototype: {
             ...
             *
             * You should check the value of isVisible() after invoking this
             * method since the before show events may have prevented it.
             *
             * @returns {HTMLElement}
             */
            show: function () {
             ...
             *
             * You should check the value of isVisible() after invoking this
             * method since the before hide events may have prevented it.
             *
             * @returns {HTMLElement}
             */
            hide: function () {
