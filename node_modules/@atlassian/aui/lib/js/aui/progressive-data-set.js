(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        global.progressiveDataSet = mod.exports;
    }
     ...
     */
    var ProgressiveDataSet = _Backbone['default'].Collection.extend({
        /**
        ...
        initialize: function initialize(models, options) {
            ...
            _2['default'].bindAll(this, 'query', 'respond');
        },
        ...
        query: function query(_query) {
            ...
            remote.always(_2['default'].bind(function () {
                this.activeQueryCount--;
                this.trigger('activity', { activity: !!this.activeQueryCount });
            }, this));

            remote.done(_2['default'].bind(function (resp, succ, xhr) {
                this.addQueryCache(_query, resp, xhr);
            }, this));
            remote.done(_2['default'].bind(function () {
                _query = this.value;
                results = this.getFilteredResults(_query);
                this.respond(_query, results);
            }, this));
        ...
        getQueryData: function getQueryData(query) {
            var params = _2['default'].isFunction(this._queryData) ? this._queryData(query) : this._queryData;
            var data = _2['default'].extend({}, params);
        ...
        fetch: function fetch(query) {
            ...
            var remote = _Backbone['default'].Collection.prototype.fetch.call(this, params);
            return remote;
        },
        ...
        getFilteredResults: function getFilteredResults(query) {
            ...
            if (this._maxResults) {
                results = _2['default'].first(results, this._maxResults);
            }
            return results;
        },
        ...
        addQueryCache: function addQueryCache(query, response, xhr) {
            ...
            cache[query] = _2['default'].pluck(results, this._idAttribute);
        },
    ...
    (0, _globalize['default'])('ProgressiveDataSet', ProgressiveDataSet);

    module.exports = ProgressiveDataSet;
});
//# sourceMappingURL=../../js/aui/progressive-data-set.js.map