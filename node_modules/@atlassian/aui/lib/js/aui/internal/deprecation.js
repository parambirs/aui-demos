(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['exports', '../jquery', './globalize'], factory);
    } else if (typeof exports !== 'undefined') {
        factory(exports, require('../jquery'), require('./globalize'));
    } else {
        var mod = {
            exports: {}
        };
    ...
    */
    function deprecateConstructor(constructorFn, displayName, options) {
        ...
        _$['default'].extend(deprecatedConstructor, constructorFn); //copy static methods across;
    ...
    function deprecateAllProperties(obj, objDisplayPrefix, options) {
        ...
        for (var attr in obj) {
            if (has.call(obj, attr)) {
                ...
                deprecateObjectProperty(obj, attr, _$['default'].extend({}, options));
            }
        }
    }
...
//# sourceMappingURL=../../../js/aui/internal/deprecation.js.map