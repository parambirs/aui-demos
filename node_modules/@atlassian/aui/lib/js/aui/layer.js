(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['exports', 'module', './jquery', './blanket', './focus-manager', './internal/globalize', './key-code', './internal/widget'], factory);
    } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
        factory(exports, module, require('./jquery'), require('./blanket'), require('./focus-manager'), require('./internal/globalize'), require('./key-code'), require('./internal/widget'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, mod, global.$, global.blanket, global.FocusManager, global.globalize, global.keyCode, global.widget);
        global.layer = mod.exports;
    }
})(this, function (exports, module, _jquery, _blanket, _focusManager, _internalGlobalize, _keyCode, _internalWidget) {
    'use strict';
    ...
    var _FocusManager = _interopRequireDefault(_focusManager);
    ...
    function triggerEvent($el, deprecatedName, newNativeName) {
        var e1 = _$['default'].Event(EVENT_PREFIX + deprecatedName);
        var e2 = _$['default'].Event(GLOBAL_EVENT_PREFIX + deprecatedName);
    ...
    function Layer(selector) {
        this.$el = (0, _$['default'])(selector || '<div class="aui-layer" aria-hidden="true"></div>');
    ...
    Layer.prototype = {
        ...
        _hideLayer: function _hideLayer(triggerBeforeEvents) {
            if (this.isPersistent() || this.isBlanketed()) {
                _FocusManager['default'].global.exit(this.$el);
            }
        ...
        _showLayer: function _showLayer(zIndex) {
            ...
            if (this.isPersistent() || this.isBlanketed()) {
                _FocusManager['default'].global.enter(this.$el);
            }
    ...
    var createLayer = (0, _widget['default'])('layer', Layer);
    ...
    function getTrigger($layer) {
        return (0, _$['default'])('[aria-controls="' + $layer.attr('id') + '"]');
    }
    ...
    LayerManager.prototype = {
        ...
        */
        push: function push(element) {
            var $el = element instanceof _$['default'] ? element : (0, _$['default'])(element);
        ...
        popLayersBeside: function popLayersBeside(element) {
            var $layer = element instanceof _$['default'] ? element : (0, _$['default'])(element);
            if (!hasTrigger($layer)) {
        ...
        */
        indexOf: function indexOf(element) {
            return layerIndex(this._stack, (0, _$['default'])(element));
        },
    ...
    (0, _globalize['default'])('layer', createLayer);

    module.exports = createLayer;
});
//# sourceMappingURL=../../js/aui/layer.js.map