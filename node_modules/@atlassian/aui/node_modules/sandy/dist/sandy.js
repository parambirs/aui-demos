...
function postToJsFiddle(sources) {
    ...
    (0, _formPost2['default'])('http://jsfiddle.net/api/post/library/pure/', jsFiddleData);
}
...
function postToJsBin(sources) {
    ...
    (0, _formPost2['default'])('http://jsbin.com/?' + panelsToDisplay.join(','), jsBinData);
}
...
function postToCodepen(sources) {
    ...
    if (sources.html) {
        codePenData.html = _depend2['default'].wrapContentInDependencies(sources.html, sources.dependencies);
    } else {
        codePenData.html = _depend2['default'].wrapContentInDependencies('', sources.dependencies);
    }
    ...
    (0, _formPost2['default'])('http://codepen.io/pen/define', {
...
module.exports = exports['default'];
},{"./depend":1,"./form-post":2}],4:[function(require,module,exports){
'use strict';
...
},{"_process":6}],"Sandy":[function(require,module,exports){
'use strict';
...
var _trimTabbedWhitespace = require('./trim-tabbed-whitespace');

var _trimTabbedWhitespace2 = _interopRequireDefault(_trimTabbedWhitespace);
...
function fetchRemoteSources(config, callback) {
    ...
    if (config.html) {
        ...
        htmlPromise.then(function (html) {
            staticSources.html = (0, _trimTabbedWhitespace2['default'])(html);
        });
    ...
    if (config.css) {
        ...
        cssPromise.then(function (css) {
            staticSources.css = (0, _trimTabbedWhitespace2['default'])(css);
        });
    ...
    if (config.js) {
        ...
        jsPromise.then(function (js) {
            staticSources.js = (0, _trimTabbedWhitespace2['default'])(js);
        });
...
module.exports = exports['default'];
},{"./post-to-sandbox":3,"./trim-tabbed-whitespace":4,"./xhr":5,"es6-promise":7}]},{},[]);
